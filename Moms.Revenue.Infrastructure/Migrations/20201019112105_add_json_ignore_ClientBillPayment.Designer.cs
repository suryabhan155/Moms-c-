...
namespace Moms.Revenue.Infrastructure.Migrations
{
    ...
    [Migration("20201019112105_add_json_ignore_ClientBillPayment")]
    partial class add_json_ignore_ClientBillPayment
    {
            ...
            modelBuilder.Entity("Moms.Revenue.Core.Domain.Billing.Models.ClientBillPayment", b =>
                {
                    ...
                    b.HasOne("Moms.Revenue.Core.Domain.Item.Models.Module", null)
                        .WithOne("ClientBillPayment")
                        .HasForeignKey("Moms.Revenue.Core.Domain.Billing.Models.ClientBillPayment", "ModuleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Moms.Revenue.Core.Domain.Billing.Models.PaymentType", null)
                        .WithOne("ClientBillPayment")
                        .HasForeignKey("Moms.Revenue.Core.Domain.Billing.Models.ClientBillPayment", "PaymentTypeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
